...
public:
    ...
    EVRInitError Activate(uint32_t unObjectId)
    {
        ...
        VRProperties()->SetStringProperty(props, Prop_InputProfilePath_String, "{right_hand}/resources/input/right_hand_pose_profile.json");
...
public:
    ...
    {
        // Possibly initialize a RightHandPose()
        // Possibly set the returnBindingsWithLeftHand to true(27:25)
